...
from garmin.utils import authenticate_to_garmin, list_virtual_cycling_activities
...
def main():
    ...
    logger.info(
        f"Found {len(new_activities)} new virtual cycling activities to upload to Garmin."
    )
